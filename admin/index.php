        ...
        <main style="flex: 1;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem; margin-bottom: 3rem;">
                <div style="background: white; padding: 2rem; border-radius: var(--radius); box-shadow: var(--shadow); border-left: 4px solid var(--primary);">
                    ...
                    <h2 style="font-size: 2rem; font-weight: 800;"><?php echo APP_CURRENCY_SYMBOL; ?><?php echo number_format($total_sales, 2); ?></h2>
                </div>
            ...
            <div style="background: white; padding: 2.5rem; border-radius: var(--radius); box-shadow: var(--shadow);">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
                    ...
                    <a href="<?php echo BASE_URL; ?>/admin/orders.php" class="btn btn-outline" style="padding: 0.5rem 1rem; font-size: 0.875rem;">View All Orders</a>
                </div>
                        ...
                        <?php else: ?>
                            <?php foreach ($recent_orders as $order): ?>
                                <tr style="border-bottom: 1px solid var(--light);">
                                    ...
                                    <td style="padding: 1rem 0; font-weight: 700;"><?php echo APP_CURRENCY_SYMBOL; ?><?php echo number_format($order['total_amount'], 2); ?></td>

            ...
            <?php foreach ($wishlist as $p): ?>
                <div class="product-card">
                    <div style="position: relative;">
                        <img src="<?php echo BASE_URL; ?>/uploads/previews/<?php echo $p['preview_image']; ?>" class="product-image">
                    ...
                    <div class="product-info">
                        ...
                        <h3 class="product-title"><a href="<?php echo BASE_URL; ?>/product.php?slug=<?php echo $p['slug']; ?>"><?php echo $p['name']; ?></a></h3>
                        ...
                        <div class="product-footer">
                            <span class="product-price"><?php echo APP_CURRENCY_SYMBOL; ?><?php echo $p['price']; ?></span>
